...
#ifndef CYBERTWIN_TEST_CLIENT_H
#define CYBERTWIN_TEST_CLIENT_H
 ...
 * \defgroup bulksend CybertwinTestClient
 *
 ...
 */
class CybertwinTestClient : public Application
{
  public:
    /**
